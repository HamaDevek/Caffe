        ...
        <table class="w-full whitespace-no-wrap datatable" style="width: 100%">
            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-sm">
                        <a href="{{route('income.show',$value->id)}}">{{$value->income }} IQD</a>
                    </td>
                    <td class="px-4 py-3 text-sm">
                        {{$value->user->name}}
                    </td>
                    ...
                    <td class=" py-3 text-sm">
                        <div class=" md:w-1/3 px-3 mb-6 md:mb-0">
                            <div class="relative ">
                                ...
                                <form id="{{"form-delete-income-" .$value->id}}"
                                    action="{{route('income.destroy',$value->id)}}" method="post" class="hidden">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </div>
    ...
    function onchangeDropdown(drop,id) {
       ...
       switch (drop.selectedIndex) {
           ...
           window.location.href = route +"/"+id + "/edit";
               break;
           case 2:
           document.getElementById('form-delete-income-'+id).submit();
               break;
           default:
               break;
       }
